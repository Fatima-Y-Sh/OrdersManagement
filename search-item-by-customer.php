  ...
  <header class="header">
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <form action="search-item-by-customer.php" method="post">
...
// for testing purposes
 $image_path='';
$result = mysqli_query($conn, "SELECT * FROM item where customer_nb=".$customer);
...
echo"   <div class='col-md-6 col-lg-3'> <div class='card mb-4'>";
   ...
   "<p class='card-text'>" . "رقم البلاك:" . $plate_nb ."</p>". "<a class='btn btn-primary' href='update-item.php?item=".$item_id."'>تعديل</a>"." 
     "."<a class='btn btn-primary' href='printing-order.php?item=".$item_id."'>أمر طباعة جديد</a>".
