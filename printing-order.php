...
$order_res=mysqli_query($conn,"SELECT * FROM orders WHERE item_nb=".$_GET["item"]." ORDER BY date_created DESC limit 1");
...
<div class="container-fluid xl-12" >
      ...
      <div class="page-breadcrumb" >
        <ul class="breadcrumb" style="padding:0">
          ...
          <li class="breadcrumb-item active">أمر طباعة</li>
  
        </ul>
      </div>
  <!-- Page Header-->
  <div class="page-header"  >
    <h1 class="arabic" style="text-align:center;"><strong>أمر طباعة </strong></h1>
    
    <h3 class="page-heading" style="text-align:center;"><?php echo date('Y-m-d');?></h3>
  </div>
            <!-- here begins the main form-->
            <form  accept-charset="utf-8" id="productInfo" action="printing-order-inter.php?item=<?php echo $item["item_id"];?>" method="post"  enctype="multipart/form-data" style="width:80%;margin-left:20%;margin-right:20%;float:none;" >
  <section >
    <div  class="row mb-5"  >
  ...
  left:0px;"  >
        <div class="card mb-4"  >
          ...
          <div style="background-color:lightyellow;" class="card-body"  style="width:100%" >
          ...
          <select name='customer' style="width: 250px; height:30px; margin: 2%">
                     ...
                     <?php
                        ...
                        echo "<option disabled selected value='". $customer_row['customer_id'] ."'>" .$customer_row['customer_name'] ."</option>";  
                      ?>
                     </select>
<br>
...
<input class="form-control mb-4" id="itemId" name="itemtId" type="text" value="<?php echo $item["item_id"];?>"  hidden>
            ...
            <input disabled class="custom-form-input" style="width:10%;"  id="item-size-x" name="itemSizex" type="text" value="<?php echo $item["final_size_x"];?>" required>
            <label class="form-label fw-bold" for="postTitle"><strong>طول</strong></label>
            <input disabled class="custom-form-input" style="width:10%;"  id="item-size-y" name="itemSizey" type="text" value="<?php echo $item["final_size_y"];?>" required>
            ...
            <label class="form-label fw-bold" for="postTitle"><strong>نوع 1</strong></label>
                <input disabled style="width:10%;" class="custom-form-input"  id="item-material-1" name="itemMaterial1" type="text" value="<?php echo $item["material_1"];?>" >
      ...
      <label class="form-label fw-bold"><strong>سماكة 1</strong></label>
         ...
         <input   class="custom-form-input" style="width:10%" name="itemGsm1" value="<?php echo $item["paper_gsm_1"];?>" disabled>
       
      <label class="form-label fw-bold"  for="postTitle"><strong> 1 عرض</strong></label>       
      <input class="custom-form-input" style="width:10%" id="paper-size-x-1" name="paperSizex1" type="text" value="<?php echo $item["paper_size_x_1"];?>" disabled>
      <label class="form-label fw-bold" for="postTitle"><strong> 1 طول</strong></label> 
      <input class="custom-form-input" style="width:10%" id="paper-size-y-1" name="paperSizey1" type="text" value="<?php echo $item["paper_size_y_1"];?>" disabled>
...
<br>
      ...
      <br>
      <label class="form-label fw-bold" for="postTitle"><strong>لون 1</strong></label>
      <input disabled class="custom-form-input" style="width:10%;" id="item-print-color-1" name="itemPrintingColor1" type="text" value="<?php echo $item["printing_color_1"];?>" >
      <label class="form-label fw-bold" for="postTitle"><strong>لون 2</strong></label>
...
<br>
                         ...
                         <input disabled class="custom-form-input" style="width:10%;" id="item-plate-nb" name="itemPlateNb" type="text" value="<?php echo $item["plate_nb"];?>" required>
                         <?php
                         $plate_res=mysqli_query($conn,"select * from plate where item_nb=".$_GET["item"]);
                         $plate=mysqli_fetch_array($plate_res);
                         ?>
                         <label class="form-label fw-bold" for="postTitle"><strong>التكرار على البلاك</strong></label>
                      
                         <input disabled style="width:10%;" class="custom-form-input" id="copies-per-plate" name="copiesPerPlate" type="text" value="<?php echo $plate["copiesperplate"];?>" required>
<label class="form-label fw-bold" for="postTitle"><strong>رقم المقطع</strong></label>
                      
                      <input disabled class="custom-form-input" style="width:10%;" id="item-cutter-nb" name="itemCutterNb" type="text" value="<?php echo $item["cutter_nb"];?>" required>                
...
<br>
          ...
          <input  class="custom-form-input" style="width:10%" id="machine-1" name="machine1" type="text" disabled value=<?php echo $item['machine_1']?> >
        
          <input  class="custom-form-input" style="width:10%" id="machine-2" name="machine2" type="text" disabled  value=<?php echo $item['machine_2']?> >
          <input  class="custom-form-input" style="width:10%" id="machine-3" name="machine3" type="text" disabled value=<?php echo $item['machine_3'] ?> >
          <br>

          <br>

          <label class="form-label fw-bold" for="postTitle"><strong>ملاحظة المنتج</strong></label> 
          <input  class="custom-form-input"  style="width:80%;" id="notes" name="itemNote" type="text" disabled value="<?php echo $item["note"];?>" >
          <br><br>
        ...
        <h4  class="arabic">صور المنتج</h4>
            ...
            <div class="row" > 
              ...
              $image_query=mysqli_query($conn,"select * from img where item_id=".$_GET["item"]);
...
{ 
  ...
  $nb_from=$order_row['number_from'];
  $nb_to=$order_row['number_to'];
}
...
<div class="card-header" > 
          ...
          <input  class="custom-form-input" style="width:10%" id="ordered-qty" name="orderedQty" type="number"  required>
          <br><br>
          <?php
  ...
  <label class="form-label fw-bold" for="postTitle"><strong>ملاحظات</strong></label> 
          <input  class="custom-form-input"  style="width:80%;" id="notes" name="orderNotes" type="text" >
          <br><br>
  <label class="form-label fw-bold" for="postTitle"><strong>مجهز الطبع (عد)</strong></label> 
          <input  class="custom-form-input" style="width:10%;" id="counter" name="counter" type="text"  >
     <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%;" id="counter-qty" name="counterQty" type="text"  >
<br>
          <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
          <fieldset id="counterSign">
                    <input  type="radio" name="counterSign" value="yes">  نعم

                    <input  type="radio" name="counterSign" value="no">  كلا
                    </fieldset>
                    <br>
          <label class="form-label fw-bold" for="postTitle"><strong>مجهز الطبع (قص)</strong></label> 
          <input  class="custom-form-input" style="width:10%;" id="precutter" name="precutter" type="text"  >
    
     <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="precutter-qty" name="precutterQty" type="text"  >
          <br>
          <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
    
                    <fieldset id="precutterSign">
                    <input  type="radio" name="precutterSign" value="yes">  نعم
                    <input  type="radio" name="precutterSign" value="no">  كلا
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>التأكد من صحة البلاك من قبل</strong></label> 
          <input  class="custom-form-input" id="checker" style="width:10%;" name="checker" type="text"  >
          <br>
          <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
       
          <fieldset id="checkerSign">
                    <input  type="radio" name="checkerSign" value="yes">  نعم
                   
                    <input  type="radio" name="checkerSign" value="no">  كلا
                    </fieldset>
                    <br>
                
                    <label class="form-label fw-bold" for="postTitle"><strong>منفذ الطباعة</strong></label> 
          <input  class="custom-form-input" id="printer" style="width:10%;" name="printer" type="text"  >

     <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="printer-qty" name="printerQty" type="text"  >
          <br>
          <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
        
          <fieldset id="printerSign">
                    <input  type="radio" name="printerSign" value="yes">  نعم
                
                    <input  type="radio" name="printerSign" value="no">  كلا
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>منفذ الترقيم</strong></label> 
                    <input  class="custom-form-input" style="width:10%;" id="numbering" name="numbering" type="text"  >
              
                    <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="numbering-qty" name="numberingQty" type="text"  >
          <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
                   
                    <fieldset id="numberingSign">
                    <input  type="radio" name="numberingSign" value="yes">  نعم
                
                    <input  type="radio" name="numberingSign" value="no">  كلا
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>منفذ التقطيع</strong></label> 
                    <input  class="custom-form-input" style="width:10%;" id="cutter" name="cutter" type="text"  >
               
                    <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="cutter-qty" name="cutterQty" type="text"  >
          <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
                  
                    <fieldset id="cutterSign">
                    <input  type="radio" name="cutterSign" value="yes">  نعم
                 
                    <input  type="radio" name="cutterSign" value="no">  كلا
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>منفذ السلوفان</strong></label> 
                    <input  class="custom-form-input" style="width:10%;" id="cellophaner" name="cellophaner" type="text"  >
                
                    <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="celliphaner-qty" name="cellophanerQty" type="text"  >
          <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
                  
                    <fieldset id="cellophanerSign">
                    <input  type="radio" name="cellophanerSign" value="yes">  نعم
              
                    <input  type="radio" name="cellophanerSign" value="no">  كلا
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>منفذ التجميع</strong></label> 
                    <input  class="custom-form-input" style="width:10%;" id="assembler" name="assembler" type="text"  >
             
                    <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="assembler-qty" name="assemblerQty" type="text"  >
          <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
                
                    <fieldset id="assemblerSign">
                    <input  type="radio" name="assemblerSign" value="yes">  نعم
               
                    <input  type="radio" name="assemblerSign" value="no">  كلا
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>منفذ الإنهاء</strong></label> 
                    <input  class="custom-form-input" style="width:10%;" id="finisher" name="finisher" type="text"  >
               
                    <label class="form-label fw-bold" for="postTitle"><strong>العدد</strong></label> 
          <input  class="custom-form-input" style="width:10%" id="finisher-qty" name="finisherQty" type="text"  >
          <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>تم التوقيع</strong></label>
                    
                    <fieldset id="finisherSign">
                    <input  type="radio" name="finisherSign" value="yes">  نعم
               
                    <input  type="radio" name="finisherSign" value="no">  كلا
                    </fieldset>
                    <br>
          ...
          <br>
                    ...
                    <input  type="radio" name="cutterType" value="old">  قديم
                
                    <input  type="radio" name="cutterType" value="new">  جديد
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>البلاك</strong></label>
                    <fieldset id="plateType">
                    <input  type="radio" name="plateType" value="old">  قديم
                
                    <input  type="radio" name="plateType" value="new">  جديد
                    </fieldset>
                    <br>
                    <label class="form-label fw-bold" for="postTitle"><strong>حالة البلاك بعد الطباعة</strong></label>
                    <fieldset id="platePostState">
                    <input  type="radio" name="platePostState" value="good">  جيد
               
                    <input  type="radio" name="platePostState" value="corrupt">  تالف
                    </fieldset>
                    <br><br>
