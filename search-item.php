  ...
  <header class="header">
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
            ...
            <input  class="custom-form-input"   style="width: 250px; height:30px; margin-left:40%;" id="search-name" name="search-name" type="text" >
            ...
            if(isset($_POST['submit'])){
              ...
              $result = mysqli_query($conn, "SELECT * FROM item where item_name LIKE '%{$search_name}%';");
    ...
    echo"   <div class='col-md-6 col-lg-3'> <div class='card mb-4'>";
                 ...
                 "<p class='card-text'>" . "رقم البلاك:" . $plate_nb ."</p>". "<a class='btn btn-primary' href='update-item.php?item=".$item_id."'>تعديل</a>"." "."<a class='btn btn-primary' href='printing-order.php?item=".$item_id."'>أمر طباعة جديد</a>"
